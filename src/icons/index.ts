...
import { ReactComponent as OrderPendingIcon } from "./order-pending.svg?react";
import { ReactComponent as OrderDeliverIcon } from "./order-deliver.svg?react";
import { ReactComponent as AuctionIcon } from "./auction.svg?react";
import { ReactComponent as UpcomingIcon } from "./upcoming-amount.svg?react";
import { ReactComponent as PendingIcon } from "./pending-amount.svg?react";
...
import { ReactComponent as FisrtIcon } from "./iconone.svg?react";
import { ReactComponent as SecondIcon } from "./icontwo.svg?react";
import { ReactComponent as ThirdIcon } from "./iconthree.svg?react";
import { ReactComponent as FourthIcon } from "./iconfour.svg?react";
import { ReactComponent as FifthIcon } from "./iconfive.svg?react";
import { ReactComponent as SixthIcon } from "./iconsix.svg?react";
import { ReactComponent as SeventhIcon } from "./iconseven.svg?react";
