...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | NZL - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for NZL - React.js Tailwind CSS Admin Dashboard Template"
      />
